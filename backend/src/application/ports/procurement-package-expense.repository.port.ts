...
export abstract class ProcurementPackageExpenseRepositoryPort {
  ...
  abstract create(
    data: CreateProcurementPackageExpenseData,
  ): Promise<ProcurementPackageExpense>;
  abstract update(
    id: string,
    data: UpdateProcurementPackageExpenseData,
  ): Promise<ProcurementPackageExpense>;
  abstract delete(id: string): Promise<void>;
  abstract sumByPackageId(packageId: string): Promise<string>;
}

export const PROCUREMENT_PACKAGE_EXPENSE_REPOSITORY = Symbol(
