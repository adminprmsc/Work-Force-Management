...
export type ProcurementPrismaAccess = {
    ...
    $transaction<T>(fn: (tx: ProcurementTransactionClient) => Promise<T>): Promise<T>;
};
export declare function asProcurementPrisma(prisma: PrismaService): ProcurementPrismaAccess;
export {};
